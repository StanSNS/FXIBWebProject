    ...
    return (
        <div className="container addMarginTop">
            ...
            <div className="d-flex justify-content-center mt-3 mb-3">
                {}
                <h2 className="first-letter-accounts-pop sectionHeaderAccountsStyling">
                    <span>A</span>
                </h2>
                <h2 className="second-letter-accounts-pop sectionHeaderAccountsStyling">
                    <span>c</span>
                </h2>
                <h2 className="third-letter-accounts-pop sectionHeaderAccountsStyling">
                    <span>c</span>
                </h2>
                <h2 className="fourth-letter-accounts-pop sectionHeaderAccountsStyling">
                    <span>o</span>
                </h2>
                <h2 className="fifth-letter-accounts-pop sectionHeaderAccountsStyling">
                    <span>u</span>
                </h2>
                <h2 className="sixth-letter-accounts-pop sectionHeaderAccountsStyling">
                    <span>n</span>
                </h2>
                <h2 className="seventh-letter-accounts-pop sectionHeaderAccountsStyling">
                    <span>t</span>
                </h2>
                <h2 className="eight-letter-accounts-pop sectionHeaderAccountsStyling">
                    <span>s</span>
                </h2>
            </div>
            {tradingAccounts.length === 0
                ? (<h1 className="mt-5 text-center errorColorText">Currently no accounts are available for
                    displaying <BiErrorCircle/></h1>)
                                ...
                                <div className="table-container ">
                                        <table className="table text-center table-hover table-no-border mb-0 ">
                                            ...
                                            <tr>
                                                <th>№</th>
                                                <th><span
                                                    className="align-text-bottom customColorClock"><TbClockPlus/></span> Open Time
                                                </th>
                                                <th><span className="align-text-bottom customColorClock"><TbClockCheck/> </span> Close Time
                                                </th>
                                                <th>Symbol</th>
                                                <th>Action</th>
                                                <th>Pips</th>
                                            ...
                                            {account.trades.map((item, index) => (
                                                <tr key={index}>
                                                    <td><span>  <strong> {account.trades.length-index} </strong></span></td>
