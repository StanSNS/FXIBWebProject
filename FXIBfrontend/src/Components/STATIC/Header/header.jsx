            ...
            <Modal show={showTransactionsModal} onHide={() => setShowTransactionsModal(false)} centered size="xl">
                <div>
                    <Modal.Header className="removeBorder">
                        ...
                        <div className=" customMessageStyleTopModal mt-1 font-weight-bolder">
                            These transactions were made with <span
                            className="customLinkDesign">EMAIL</span>: {userTransactions[0]?.userEmail}
                        </div>
                    ...
                    <Modal.Body>
                        {userDetails && userTransactions && userTransactions.length > 0 ? (
                            ...
                            <p className="errorMessageNoTransactions">You Haven't Made Any Transactions
                                Yet <BiSolidError/></p>
                        )}
                    </Modal.Body>
                    <Modal.Footer className="justify-content-center removeBorder p-0 m-0 mb-3">
